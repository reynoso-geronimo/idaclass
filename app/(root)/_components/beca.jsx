      ...
      <div className="flex flex-col lg:flex-row gap-4 items-stretch justify-center">
        <article className="w-full flex flex-col items-start  p-8 border-2 border-black rounded-3xl">
          ...
          <p className="font-bold my-4">
            Nuestros especialistas están disponibles <br /> para escucharte y despejar
            todas tus dudas
          </p>
        ...
        <div className="bg-black w-full text-white text-center p-8 overflow-hidden rounded-3xl">
          <TituloSeccion className={"mb-4"}>
            Beca<span className="inline text-idaclass4">Class</span> 40 %
          </TituloSeccion>
          ...
          <div className="w-full relative">
            ...
            <div className="absolute right-[15%] bottom-24 rotate-[90deg] opacity-35">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="22.769"
                height="14.821"
                className="fill-idaclass scale-[900%] lg:scale-[1200%] opacity-100 z-10"
              >
