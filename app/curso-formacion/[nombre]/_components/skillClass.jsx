  ...
  return (
    <section className="relative w-full lg:w-[50%] flex flex-col justify-stretch items-center  lg:rounded-3xl overflow-hidden py-12 bg-gradient-to-t from-[#3A5DAE] to-[#1D2F57]">
     {/* //!!CORREGIR IMAGEN */}
      ...
      <Badge className="text-lg text-center font-semibold justify-center bg-idaclass w-full lg:w-[26rem] px-8">
        BONO EXTRA
      </Badge>
      <h3 className="text-center text-5xl lg:text-6xl font-bold m-4 text-white w-full lg:w-[26rem] px-8">
        SkillClass
      </h3>
      <div className="rounded-3xl overflow-hidden bg-white w-full lg:w-[26rem] px-8">
