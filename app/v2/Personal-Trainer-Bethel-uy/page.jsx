...
import TarjetaModalidad from "./components/tarjeta-modalidad-uy";
...
const page = async () => {
  ...
  return (
    <main className="flex flex-col justify-start grow">
      ...
      <div className="flex flex-col gap-4 lg:flex-row items-center justify-around container relative max-lg:bg-gradient-to-b from-[#12182D] to-[#1C2C53] ">
        <Image
        ...
        <div className="space-y-6 text-white z-10 pb-6">
          ...
          <p className="lg:text-lg ">
            <Clock className="inline mr-2 size-7" />
            <span className="font-bold"> Horario :</span> Sábados de 14 a 16 hs
          </p>
        </div>
      </div>
