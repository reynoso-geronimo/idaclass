...
const valores = [
  {
    title: "Innovación",
    description:
      "Abrazamos la innovación tecnológica en la educación, proporcionando un ambiente de aprendizaje virtual dinámico y accesible.",
  ...
  },
  {
    ...
    description:
      "Fomentamos el espíritu emprendedor en cada uno de nuestros estudiantes. Creemos en el poder de la innovación y la creatividad para transformar el mundo del fitness y el bienestar.",
    // link: "https://netflix.com",
  ...
  },
  {
    title: "Liderazgo",
    description:
      "En IdaClass, cultivamos el liderazgo en todos los niveles. Inspiramos a nuestros estudiantes a convertirse en líderes en sus campos, capacitándolos con las habilidades y la confianza necesarias para liderar con éxito en el mundo del fitness y el bienestar.",
  ...
  },
  {
    title: "Inclusión",
    description:
      "La inclusión es un pilar fundamental de nuestra comunidad. Nos comprometemos a crear un ambiente acogedor y diverso donde cada persona se sienta valorada y respetada. Celebramos la diversidad en todas sus formas y promovemos la igualdad de oportunidades para todos.",
    // link: "https://meta.com",
  ...
  return (
    <main className="w-full flex flex-col items-center">
      ...
      <section className="container px-0 flex flex-col items-center bg-slate-220 gap-4 py-12">
        <h2 className="text-3xl font-extrabold text-idaclass">
          Nuestros <span className="text-idaclass4">Valores</span>
        </h2>
