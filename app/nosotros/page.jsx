        ...
        <div className="flex flex-col justify-center items-center w-full max-w-3xl gap-10 pt-12">
          <article className="flex items-center justify-center mr-auto">
            ...
            <div className="w-56">
              ...
              <p className="text-pretty md:text-lg">
                IDACLASS, es fundada en Octubre 2021 en Florida, EE.UU., por
                Julio Alghilante ,Argentino residente en Buenos Aires. Cabe
                destacar que Julio, inició este negocio en forma presencial en
                Argentina hace más de 20 años, llegando a tener 40.000 alumnos
                distribuidos principalmente en Argentina, Uruguay y Bolivia.
                Producto de la pandemia, el negocio se vió fuertemente afectado
                y fue entonces que se fundó una nueva compañía en USA con el
                objetivo de una revolución Digital para la empresa misma
                buscando innovar en tecnología ,servicio y expandirnos asi a
                todo Latino America.
              </p>
            </div>
          </article>
          <article className="flex flex-row-reverse items-center justify-center ml-auto">
            ...
            <div className="w-56">
              ...
              <p className="text-pretty md:text-lg">
                Esta nueva compañía, Edtech para el deporte y la actividad
                física, propone virtualizar el negocio y vender online a todo
                Hispanoamérica. Vendemos cursos de formación y especialización
                para la industria del deporte , actividad física y fitness.
                Formamos a entrenadores y especialistas que luego pueden
                emprender sus propios negocios independientes y/o trabajar luego
                en instituciones deportivas y gimnasios.
              </p>
            </div>
          </article>
          ...
          <article className="flex items-center justify-center mr-auto">
            ...
            <div className="w-56">
              ...
              <p className="text-pretty md:text-lg">
                En el horizonte de IdaClass LLC, vislumbramos un futuro vibrante
                y prometedor, marcado por nuestra incansable dedicación a
                transformar la educación y la formación en el ámbito del deporte
                y la actividad física en Hispanoamérica.
              </p>
            </div>
          </article>
        </div>
