...
const RegisterForm = () => {
  ...
  return (
    <div className="max-w-md mx-auto  border-2 border-cyan-400 rounded-3xl p-6 relative flex flex-col">
    {/* Badge superior */}
    ...
    <Form {...form}>
      <form
        ...
        className="justify-between space-y-1 z-10  h-fit py-12 px-4 rounded-3xl flex-1 flex flex-col"
      >
          <h2 className="font-bold text-center text-[#22B0E6]">Completa el formulario con tus datos y cumple hoy tu sueño junto a IdaClass</h2>
