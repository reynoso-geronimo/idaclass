...
const Footer = () => {
  ...
  if (pathname.includes("v2") || pathname.includes("v3") || pathname.includes("landingfitnessnegocios") || pathname.includes("masterclass") || pathname.includes("eventos")) return null;
  return (
