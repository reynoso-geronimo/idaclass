...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[2500px] md:h-[2500px] py-40 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
      ...
      >
        ...
        <motion.div className="flex flex-row  mb-14 space-x-20 ">
...
export const ProductCard = ({ product, translate }) => {
  return (
    <motion.div
      ...
      key={product.title}
      className="group/product h-72 w-[12rem] lg:w-[24rem] relative flex-shrink-0"
    >
      {/* <Link
        href={product.link}
