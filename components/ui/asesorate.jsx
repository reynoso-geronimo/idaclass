...
const Asesorate = () => {
  return (
    <article className="w-full relative rounded-3xl ">
      <div className=" flex flex-col items-end justify-evenly w-5/12 ml-auto mr-2 lg:mr-6 h-full min-h-72">
        ...
        <p className="my-4 text-sm sm:text-base z-10 text-balanced">
          Nuestros asesores están disponibles para escucharte y despejar todas
          tus dudas
        </p>
       
          <Button size="default" className="bg-green-500 px-2 w-full z-10" asChild>
