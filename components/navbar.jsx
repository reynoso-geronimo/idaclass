...
const NavBar = ({ cursosFormacion, cursosEspecializacion }) => {
  ...
  if (pathname.includes("v2") || pathname.includes("v3") || pathname.includes("Transforma-Tu-Pasion-en-Profesion-de-Impacto") || pathname.includes("landingfitnessnegocios") || pathname.includes("masterclass")) return null;
  return (
